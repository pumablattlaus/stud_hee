...
import rospy
import actionlib
from geometry_msgs.msg import PoseWithCovarianceStamped, PoseStamped, Point, Twist, TwistStamped, Pose
...
def poseCallback(pose_message):
    ...
    yaw = pose_message.pose.pose.orientation.theta
...
def move_goal(velocity_publisher, x_goal, y_goal):
    velocity_message = Twist() # Type: Twist()
